<?php
/*
Plugin Name: Copyshop Product Add-ons
Plugin URI: http://bikashwaiba.wordpress.com
Description: Copyshop Product Add-ons lets you add extra options to products which the user can select. Add-ons can be checkboxes, a select box, or custom input. Each option can optionally be given a price which is added to the cost of the product.
Version: 1.0
Author: Bikash Waiba
Author URI: http://bikashwaiba.wordpress.com
