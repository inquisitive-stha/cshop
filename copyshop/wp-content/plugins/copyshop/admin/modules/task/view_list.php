...
<table class="wp-list-table widefat fixed striped pages">
    ...
    <tbody id="nrow">
        ...
        <tr id="tr-<?php echo $l->id; ?>">
            ...
            <th>
                <input type="text" disabled class="db_attributes form-control percent_50" value="<?php echo $l->attributes; ?>" />
            </th>
            <th>
...
<script type="text/javascript">
    ...
    function doEdit(b)
    {
        ...
        jQuery.ajax({
                ...
                data: { action: "savetask", title: title,setup_charge: setup_charge,attributes: attributes,options: options, id: id}
              })
                .done(function( msg ) {
                    if(msg.success == '1')
                    {
    ...
    function doAdd(b)
    {
        ...
        jQuery.ajax({
                ...
                dataType: "json",
                url: "<?php echo admin_url('admin-ajax.php'); ?>",
                data: { action: "savetask", title: title,setup_charge: setup_charge,attributes: attributes,options: options}
              })
                .done(function( msg ) {
                    if(msg.success == '1')
                    {
